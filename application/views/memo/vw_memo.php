						...
						<table class="table table-condensed" id="table-ah">
							...
							<tbody>
								...
								<tr>
									...
									<td><a title="Edit data" href="<?php echo site_url('memo/show/'.$k->no_disposisi); ?>" class="btn btn-primary"><i class="fa fa-navicon"></i></a>&nbsp;&nbsp;<a title="Lihat dokumen" href="javascipr:void(0)" onclick="window.open('<?php echo base_url('uploads/'.$k->nama_file); ?>')" class="btn btn-warning"><i class="fa fa-file-pdf-o"></i></a>&nbsp;&nbsp;<a title="Lihat dokumen" href="javascipr:void(0)" onclick="window.open('<?php echo base_url('uploads/'.$k->nama_file); ?>')" class="btn btn-warning"><i class="fa fa-eye"></i></a></td>
								</tr>
							<?php endforeach; ?>
							</tbody>
						</table>
