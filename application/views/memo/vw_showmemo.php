			...
			<div class="container-fluid">
				<div class="panel">
					...
					<div class="panel-body">
						...
						<?php foreach ($tracking as $k): ?>
						<p><b><?php echo $k->waktu; ?> </b> Sudah terdisposisi ke <?php echo $k->nama_divisi; ?></p>
						<?php endforeach; ?>
					</div>
					<?php foreach ($query_surat as $k): ?>
					<div class="panel-footer">
						<h5><a href="<?php echo site_url('disposisi/input_disposisi/'.$k->id); ?>" class="btn btn-primary"><i class="fa fa-ok"></i>&nbsp;&nbsp;Disposisi</a></h5>
					</div>
					<?php endforeach; ?>
				</div>
			</div>
