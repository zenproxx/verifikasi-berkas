...
<nav class="navbar navbar-default">
	<div class="brand">
		 <a href="<?php echo site_url('dashboard'); ?>"><img width="30" height="10" src="<?php echo base_url('assets/img/logo-dark.png'); ?>" alt="Klorofil Logo"  class="img-responsive logo"></a> 
